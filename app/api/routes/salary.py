...
from services.salary_service import get_salary_details, create_salary_details, update_salary_details, del_salary_details
...
async def delete_salary(employee_id: int, db: Session = Depends(get_db)):
